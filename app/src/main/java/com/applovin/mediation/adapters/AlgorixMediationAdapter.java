...
public class AlgorixMediationAdapter extends MediationAdapterBase implements MaxAdViewAdapter, MaxInterstitialAdapter, MaxRewardedAdapter, MaxNativeAdAdapter {
    ...
    //private static final String ADAPTER_SDK_HOST_URL = "https://raftingadx.svr.rixengine.com/rtb";
    private static final String ADAPTER_SDK_HOST_URL = "http://testaa.rixengine.com/rtb";
